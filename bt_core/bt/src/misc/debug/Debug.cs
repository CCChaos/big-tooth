...
namespace BTMISC
{
	...
	public class BTDebug
	{
		...
		public static void Log(System.Object logObject)
		{
			string strLog = FormatMessage(TDebugLevel.enLog, logObject);
			if (m_handleLog == null)
			{
				DefaultLog(strLog);
				return;
		...
		/// </summary>
		/// <param name="logObject"></param>
		public static void Warning(System.Object logObject)
		{
			string strLog = FormatMessage(TDebugLevel.enWarning, logObject);
		...
		/// </summary>
		/// <param name="logObject"></param>
		public static void Error(System.Object logObject)
		{
			string strLog = FormatMessage(TDebugLevel.enError, logObject);
		...
		/// </summary>
		/// <param name="logObject"></param>
		public static void Exception(System.Object logObject)
		{
			string strLog = FormatMessage(TDebugLevel.enException, logObject);
