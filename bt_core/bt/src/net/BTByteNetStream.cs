...
namespace BTMISC
{
	...
	/// </summary>
	public class CBTByteNetStream : CByteStream
	{
		/// <summary>
		/// BT消息协议头长度
		/// </summary>
...
#region Methods
		...
		/// Construct
		/// </summary>
		public CBTByteNetStream(bool bIsLittelEndian)
		...
		public CBTByteNetStream(Byte[] dataArray, bool bIsLitteEndian)
		...
		public CBTByteNetStream(Byte[] dataArray, Int32 nOffset, Int32 nLength, bool bIsLitteEndian)
